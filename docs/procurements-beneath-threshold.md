...
| **CODE**      | A combobox/dropdown list where the user selects one value from a predefined list.
Radio buttons where all options are visible, but only one may be selected. A checkbox control, that allows multiple selections (e.g. CPV codes). |
...
| 📝 BT-765-Lot  | Framework Agreement                     | */*/cac:ProcurementProjectLot[cbc:ID/@schemeName='Lot']/*<br>*cac:TenderingProcess/*<br>*cac:ContractingSystem[*<br>*cbc:ContractingSystemTypeCode/@listName='framework-agreement']/*<br>*cbc:ContractingSystemTypeCode* | CODE             | Mandatory: Always mandatory in E3.                                                                                            |
