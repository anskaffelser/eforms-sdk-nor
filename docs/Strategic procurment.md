...
In Norway we do not have a seperate law to ensure green procurement, and therefore we want to implement the framework in eforms, as is. If BT-776 (codelist) is fullfilled, it leads to fulfillmet of the *strategic procurement* code BT-06. Label with innovation icon occurs when BT-776 or BT-06. is present in the CN og CAN notice.
